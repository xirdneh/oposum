...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LayawayProduct'
        db.create_table(u'layaway_layawayproduct', (
        ...
        db.send_create_signal(u'layaway', ['LayawayProduct'])
    ...
    def backwards(self, orm):
        # Deleting model 'LayawayProduct'
        db.delete_table(u'layaway_layawayproduct')
