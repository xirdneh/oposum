...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayawayHistory.branch'
        db.add_column(u'layaway_layawayhistory', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['branches.Branch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayawayHistory.branch'
        db.delete_column(u'layaway_layawayhistory', 'branch_id')
