...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Layaway.client'
        db.delete_column(u'layaway_layaway', 'client_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Layaway.client'
        raise RuntimeError("Cannot reverse this migration. 'Layaway.client' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Layaway.client'
        db.add_column(u'layaway_layaway', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Client']),
                      keep_default=False)
