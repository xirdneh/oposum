...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExistenceHistoryDetail'
        db.create_table(u'inventory_existencehistorydetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Product'])),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('existence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.ExistenceHistory'], null=True, blank=True)),
        ))
        db.send_create_signal(u'inventory', ['ExistenceHistoryDetail'])

        # Deleting field 'ExistenceHistory.existence'
        db.delete_column(u'inventory_existencehistory', 'existence_id')


    def backwards(self, orm):
        # Deleting model 'ExistenceHistoryDetail'
        db.delete_table(u'inventory_existencehistorydetail')


        # User chose to not deal with backwards NULL issues for 'ExistenceHistory.existence'
        raise RuntimeError("Cannot reverse this migration. 'ExistenceHistory.existence' and its values cannot be restored.")
