...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventoryEntry.date_time'
        db.add_column(u'inventory_inventoryentry', 'date_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InventoryEntry.date_time'
        db.delete_column(u'inventory_inventoryentry', 'date_time')
