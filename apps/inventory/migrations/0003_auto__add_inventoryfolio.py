...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InventoryFolio'
        db.create_table(u'inventory_inventoryfolio', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'inventory', ['InventoryFolio'])


    def backwards(self, orm):
        # Deleting model 'InventoryFolio'
        db.delete_table(u'inventory_inventoryfolio')
