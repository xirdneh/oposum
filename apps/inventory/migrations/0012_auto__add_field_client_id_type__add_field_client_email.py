...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.id_type'
        db.add_column(u'inventory_client', 'id_type',
                      self.gf('django.db.models.fields.CharField')(default='IFE', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Client.email'
        db.add_column(u'inventory_client', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.id_type'
        db.delete_column(u'inventory_client', 'id_type')

        # Deleting field 'Client.email'
        db.delete_column(u'inventory_client', 'email')
