...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.payment_method'
        db.add_column(u'pos_sale', 'payment_method',
                      self.gf('django.db.models.fields.CharField')(default='Cash', max_length=255),
                      keep_default=False)

        # Adding field 'Sale.payment_amount'
        db.add_column(u'pos_sale', 'payment_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.payment_method'
        db.delete_column(u'pos_sale', 'payment_method')

        # Deleting field 'Sale.payment_amount'
        db.delete_column(u'pos_sale', 'payment_amount')
