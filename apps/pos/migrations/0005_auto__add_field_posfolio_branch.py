...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'POSFolio.branch'
        db.add_column(u'pos_posfolio', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='oficina', to=orm['branches.Branch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'POSFolio.branch'
        db.delete_column(u'pos_posfolio', 'branch_id')
