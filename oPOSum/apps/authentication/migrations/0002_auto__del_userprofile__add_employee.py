...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'authentication_userprofile')

        # Adding model 'Employee'
        db.create_table(u'authentication_employee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['branches.Branch'], blank=True)),
        ))
        db.send_create_signal(u'authentication', ['Employee'])


    def backwards(self, orm):
        # Adding model 'UserProfile'
        db.create_table(u'authentication_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['branches.Branch'], blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'authentication', ['UserProfile'])

        # Deleting model 'Employee'
        db.delete_table(u'authentication_employee')
    ...
    models = {
        ...
        u'authentication.employee': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['branches.Branch']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
