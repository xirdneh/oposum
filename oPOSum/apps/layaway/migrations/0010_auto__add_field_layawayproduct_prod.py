...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayawayProduct.prod'
        db.add_column(u'layaway_layawayproduct', 'prod',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['products.Product']),
                      keep_default=False)

        # Removing M2M table for field product on 'LayawayProduct'
        db.delete_table(db.shorten_name(u'layaway_layawayproduct_product'))


    def backwards(self, orm):
        # Deleting field 'LayawayProduct.prod'
        db.delete_column(u'layaway_layawayproduct', 'prod_id')

        # Adding M2M table for field product on 'LayawayProduct'
        m2m_table_name = db.shorten_name(u'layaway_layawayproduct_product')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('layawayproduct', models.ForeignKey(orm[u'layaway.layawayproduct'], null=False)),
            ('product', models.ForeignKey(orm[u'products.product'], null=False))
        ))
        db.create_unique(m2m_table_name, ['layawayproduct_id', 'product_id'])
    ...
    models = {
        ...
        u'layaway.layaway': {
            ...
            'amount_to_pay': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '10', 'decimal_places': '2'}),
        ...
        u'layaway.layawayhistory': {
            ...
            'payment_type': ('django.db.models.fields.CharField', [], {'default': "'Cash'", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'layaway.layawayproduct': {
            'Meta': {'object_name': 'LayawayProduct'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layaway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['layaway.Layaway']"}),
            'prod': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Product']"}),
