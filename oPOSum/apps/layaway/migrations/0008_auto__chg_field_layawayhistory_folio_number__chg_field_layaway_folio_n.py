...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LayawayHistory.folio_number'
        db.alter_column(u'layaway_layawayhistory', 'folio_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Layaway.folio_number'
        db.alter_column(u'layaway_layaway', 'folio_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'LayawayHistory.folio_number'
        db.alter_column(u'layaway_layawayhistory', 'folio_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Layaway.folio_number'
        db.alter_column(u'layaway_layaway', 'folio_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
