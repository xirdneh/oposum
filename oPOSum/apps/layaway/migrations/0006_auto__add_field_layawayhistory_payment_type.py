...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayawayHistory.payment_type'
        db.add_column(u'layaway_layawayhistory', 'payment_type',
                      self.gf('django.db.models.fields.CharField')(default='Cash', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayawayHistory.payment_type'
        db.delete_column(u'layaway_layawayhistory', 'payment_type')
