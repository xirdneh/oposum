...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayawayProduct.price'
        db.add_column(u'layaway_layawayproduct', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayawayProduct.price'
        db.delete_column(u'layaway_layawayproduct', 'price')
