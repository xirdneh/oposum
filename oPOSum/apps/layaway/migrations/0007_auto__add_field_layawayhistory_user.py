...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayawayHistory.user'
        db.add_column(u'layaway_layawayhistory', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayawayHistory.user'
        db.delete_column(u'layaway_layawayhistory', 'user_id')
