...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SaleDetails.over_price'
        db.add_column(u'pos_saledetails', 'over_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SaleDetails.over_price'
        db.delete_column(u'pos_saledetails', 'over_price')
