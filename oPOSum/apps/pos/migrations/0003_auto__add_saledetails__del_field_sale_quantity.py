...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SaleDetails'
        db.create_table(u'pos_saledetails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Product'])),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pos.Sale'], null=True, blank=True)),
        ))
        db.send_create_signal(u'pos', ['SaleDetails'])

        # Deleting field 'Sale.quantity'
        db.delete_column(u'pos_sale', 'quantity')

        # Removing M2M table for field product on 'Sale'
        db.delete_table(db.shorten_name(u'pos_sale_product'))


    def backwards(self, orm):
        # Deleting model 'SaleDetails'
        db.delete_table(u'pos_saledetails')

        # Adding field 'Sale.quantity'
        db.add_column(u'pos_sale', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding M2M table for field product on 'Sale'
        m2m_table_name = db.shorten_name(u'pos_sale_product')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sale', models.ForeignKey(orm[u'pos.sale'], null=False)),
