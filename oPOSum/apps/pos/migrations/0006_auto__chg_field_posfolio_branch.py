...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'POSFolio.branch'
        db.alter_column(u'pos_posfolio', 'branch_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['branches.Branch'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'POSFolio.branch'
        raise RuntimeError("Cannot reverse this migration. 'POSFolio.branch' and its values cannot be restored.")
