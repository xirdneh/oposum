...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExistenceHistory.printed'
        db.add_column(u'inventory_existencehistory', 'printed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExistenceHistory.printed'
        db.delete_column(u'inventory_existencehistory', 'printed')
