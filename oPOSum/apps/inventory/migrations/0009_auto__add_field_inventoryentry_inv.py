...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventoryEntry.inv'
        db.add_column(u'inventory_inventoryentry', 'inv',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['inventory.Inventory'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InventoryEntry.inv'
        db.delete_column(u'inventory_inventoryentry', 'inv_id')
