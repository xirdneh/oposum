...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExistenceHistory.folio_number'
        db.add_column(u'inventory_existencehistory', 'folio_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExistenceHistory.folio_number'
        db.delete_column(u'inventory_existencehistory', 'folio_number')
