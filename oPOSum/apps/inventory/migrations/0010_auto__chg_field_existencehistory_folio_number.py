...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExistenceHistory.folio_number'
        db.alter_column(u'inventory_existencehistory', 'folio_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExistenceHistory.folio_number'
        db.alter_column(u'inventory_existencehistory', 'folio_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
