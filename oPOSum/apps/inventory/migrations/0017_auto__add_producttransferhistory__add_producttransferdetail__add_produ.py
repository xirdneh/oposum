...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductTransferHistory'
        db.create_table(u'inventory_producttransferhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status_previous', self.gf('django.db.models.fields.TextField')(max_length=255)),
            ('status_changed', self.gf('django.db.models.fields.TextField')(max_length=255)),
            ('product_transfer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.ProductTransfer'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'inventory', ['ProductTransferHistory'])

        # Adding model 'ProductTransferDetail'
        db.create_table(u'inventory_producttransferdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'inventory', ['ProductTransferDetail'])

        # Adding model 'ProductTransfer'
        db.create_table(u'inventory_producttransfer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('branch_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from', to=orm['branches.Branch'])),
            ('branch_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to', to=orm['branches.Branch'])),
            ('status', self.gf('django.db.models.fields.TextField')(max_length=255)),
            ('date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'inventory', ['ProductTransfer'])


    def backwards(self, orm):
        # Deleting model 'ProductTransferHistory'
        db.delete_table(u'inventory_producttransferhistory')

        # Deleting model 'ProductTransferDetail'
        db.delete_table(u'inventory_producttransferdetail')

        # Deleting model 'ProductTransfer'
        db.delete_table(u'inventory_producttransfer')
    ...
    models = {
        ...
        u'inventory.existencehistory': {
            'Meta': {'object_name': 'ExistenceHistory'},
            'action': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['branches.Branch']"}),
            'date_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'details': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'extra': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'folio_number': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'printed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'inventory.existencehistorydetail': {
            'Meta': {'object_name': 'ExistenceHistoryDetail'},
            'existence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.ExistenceHistory']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Product']"}),
        ...
        u'inventory.inventory': {
            ...
            'adjusting': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': u"orm['branches.Branch']"}),
            'comments': ('django.db.models.fields.TextField', [], {'max_length': '1024', 'blank': 'True'}),
            'date_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'inventory.inventoryadjustment': {
            'Meta': {'object_name': 'InventoryAdjustment'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inventory_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.InventoryEntry']"}),
            'message': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'inventory.inventoryentry': {
            'Meta': {'object_name': 'InventoryEntry'},
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inv': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Inventory']", 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Product']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'inventory.inventoryfolio': {
            'Meta': {'object_name': 'InventoryFolio'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'value': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'inventory.producttransfer': {
            'Meta': {'object_name': 'ProductTransfer'},
            'branch_from': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'from'", 'to': u"orm['branches.Branch']"}),
            'branch_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'to'", 'to': u"orm['branches.Branch']"}),
            'date_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.TextField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'inventory.producttransferdetail': {
            'Meta': {'object_name': 'ProductTransferDetail'},
            'date_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Product']"}),
            'product_transfer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.ProductTransfer']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'})
        },
        u'inventory.producttransferhistory': {
            'Meta': {'object_name': 'ProductTransferHistory'},
            'date_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product_transfer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.ProductTransfer']"}),
            'status_changed': ('django.db.models.fields.TextField', [], {'max_length': '255'}),
            'status_previous': ('django.db.models.fields.TextField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'products.product': {
