...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inventory.adjusting'
        db.add_column(u'inventory_inventory', 'adjusting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inventory.adjusting'
        db.delete_column(u'inventory_inventory', 'adjusting')
