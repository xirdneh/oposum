...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_existence', (
        ...
        db.send_create_signal(u'inventory', ['Existence'])

        # Adding model 'ExistenceHistory'
        db.create_table(u'inventory_existencehistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('extra', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('existence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Existence'])),
        ))
        db.send_create_signal(u'inventory', ['ExistenceHistory'])
        ...
        db.create_table(u'inventory_client', (
            ...
            ('phonenumber', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'inventory_existence')

        # Deleting model 'ExistenceHistory'
        db.delete_table(u'inventory_existencehistory')
    ...
    models = {
        ...
        u'inventory.existencehistory': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'existence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Existence']"}),
