...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExistenceHistory.branch'
        db.add_column(u'inventory_existencehistory', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['branches.Branch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExistenceHistory.branch'
        db.delete_column(u'inventory_existencehistory', 'branch_id')
