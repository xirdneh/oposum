...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InventoryAdjustment'
        db.create_table(u'inventory_inventoryadjustment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inventory_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryEntry'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('message', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'inventory', ['InventoryAdjustment'])

        # Adding field 'ExistenceHistory.details'
        db.add_column(u'inventory_existencehistory', 'details',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InventoryAdjustment'
        db.delete_table(u'inventory_inventoryadjustment')

        # Deleting field 'ExistenceHistory.details'
        db.delete_column(u'inventory_existencehistory', 'details')
