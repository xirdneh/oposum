...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inventory.date_time'
        db.alter_column(u'inventory_inventory', 'date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Inventory.date_time'
        db.alter_column(u'inventory_inventory', 'date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
