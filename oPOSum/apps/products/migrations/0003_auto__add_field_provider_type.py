...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.type'
        db.add_column(u'products_provider', 'type',
                      self.gf('django.db.models.fields.CharField')(default=u'ORO', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.type'
        db.delete_column(u'products_provider', 'type')
