...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductLine.slug'
        db.delete_column(u'products_productline', 'slug')

        # Adding field 'ProductLine.name'
        db.add_column(u'products_productline', 'name',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProductLine.slug'
        db.add_column(u'products_productline', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'ProductLine.name'
        db.delete_column(u'products_productline', 'name')
