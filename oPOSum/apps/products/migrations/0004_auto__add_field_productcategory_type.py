...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.type'
        db.add_column(u'products_productcategory', 'type',
                      self.gf('django.db.models.fields.SlugField')(default='bodega', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductCategory.type'
        db.delete_column(u'products_productcategory', 'type')
